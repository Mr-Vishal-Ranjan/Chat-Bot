...
export function SettingsSection(props) {
  ...
  return (
    <section
      id="aside"
      className="full md:half lg:quarter lg:screen-v-scroll flex row wrap"
    >
      <div className="pt px">
        ...
        >
          {EngineList.map((item, index) => (
            <option key={index} value={item.engineId} disabled={!item.enabled}>
              {item.engineId}
            </option>
          ))}
        </select>
        ...
        {/* <a href={"#"} onClick={resetConversation} className={"fuschia hover"}>
          Reset
        </a> */}
      </div>
    </section>
